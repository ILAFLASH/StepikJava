...
public class Analyzer {
    ...
    public static void main(String[] args) {
        String[] kw = new String[] {"Hello", "Bye"};
        SpamAnalyzer sp = new SpamAnalyzer(kw);
        NegativeTextAnalyzer nta = new NegativeTextAnalyzer();
        TooLongTextAnalyzer tlta = new TooLongTextAnalyzer(10);
        System.out.println(checkLabels(new TextAnalyzer[] {sp, nta, tlta}, "Hello :x|Beye) sdfdsfdsfdsfdfsdsdf"));
    }
}
